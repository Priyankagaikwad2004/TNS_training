...
public class Main {
    ...
    static void menu(int accNo) throws IOException {
        ...
        System.out.println("│ Type 6: Withdraw           │");
        System.out.println("│ Type 7: Change Password    │");
        System.out.println("│----------------------------│");
        System.out.println("│ Type 8: Log out            │");
        ...
        switch (choice) {
            ...
            case 5 -> doDeposit(accNo);
            case 6 -> doWithdraw(accNo);
            case 7 -> changePass(accNo);
            case 8 -> {
    ...
    private static void accClose(int accNo) throws IOException {
        ...
        deletion.accCloseFun(accNo);  // JDBC delete
    }

    // ---- NEW METHODS -----

    private static void doDeposit(int accNo) {
        Deposit d = new Deposit();
        d.depositFun(accNo);
    }

    private static void doWithdraw(int accNo) {
        Withdraw w = new Withdraw();
        w.withdrawFun(accNo);
    }

    private static void changePass(int accNo) {
        ChangePassword c = new ChangePassword();
        c.changePasswordFun(accNo);
    }
}
